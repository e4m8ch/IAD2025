...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.redButton.clicked.connect(self.onBlueButtonClick)
        ...
        self.blueButton.clicked.connect(self.onRedButtonClick)
